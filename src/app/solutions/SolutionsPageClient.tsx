        ...
        <div className={styles.container}>
          <div className={styles.solutionInner}>
            <div className={styles.solutionCopy}>
              ...
              <a href="#" className={styles.solutionCta}>Start Free Trial → your first course live in minutes</a>
            </div>
            <CourseMockup />
          </div>
        </div>
      ...
      <section className={styles.midCtaSection}>
        <div className={styles.container}>
          ...
          <div className={styles.midCtaButtons}>
            <button className={styles.ctaBtnPrimary} id="mid-cta-trial">
              Start Free Trial →
            </button>
      ...
      <section className={styles.footerCtaSection}>
        <div className={styles.container}>
          ...
          <div className={styles.footerCtaButtons}>
            <button className={styles.footerBtnNavy} id="footer-cta-trial">
              Start Free Trial →
            </button>
