  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.heroSection}>
        <div className={styles.container}>
          ...
          <div className={styles.heroCtas}>
            <a href={COMPANY_WHATSAPP_CTA_URL} target="_blank" rel="noopener noreferrer" className={styles.heroCtaPrimary}>
              Get a free demo →
            </a>
        ...
        <div className={styles.container}>
          <div className={styles.solutionInner}>
            <div className={styles.solutionCopy}>
              ...
              <a href={COMPANY_WHATSAPP_CTA_URL} target="_blank" rel="noopener noreferrer" className={styles.solutionCta}>Chat with us → your first course live in minutes</a>
            </div>
            <CourseMockup />
          </div>
        </div>
      ...
      <div className={styles.midBreak}>
        ...
        <a href={COMPANY_WHATSAPP_CTA_URL} target="_blank" rel="noopener noreferrer" className={styles.midBreakBtn}>Get a free demo →</a>
      ...
      <section className={styles.footerCtaSection}>
        <div className={styles.container}>
          ...
          <div className={styles.footerCtaButtons}>
            <a href={COMPANY_WHATSAPP_CTA_URL} target="_blank" rel="noopener noreferrer" className={styles.footerBtnNavy} id="footer-cta-trial">
              Get a free demo →
            </a>
            <a href={COMPANY_WHATSAPP_CTA_URL} target="_blank" rel="noopener noreferrer" className={styles.footerBtnGreen} id="footer-cta-whatsapp">
